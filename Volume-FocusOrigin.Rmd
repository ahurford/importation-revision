...
p6 <- ggplot() +
  ...
  geom_text(mapping = aes(x = vals, y = 30000, label = Ref, hjust = .13, vjust =  0.1, angle = 0), data = cut3, size=rel(4), color= "black")  +
...
m1 <- pr_geographic %>%
  ...
  annotate(geom = "text", x = 642412.6, y = 201110.2, label = "27%", color = "black", size = 3)+
  annotate(geom = "text", x = 1349519.2, y = 782762.2,label = "15%", color = "white", size = 3)+
  annotate(geom = "text", x = -115306.8, y = 644233.4,label = "0.7%",color = "white", size = 3)+
  annotate(geom = "text", x = 2163606.1, y = 0, label = "3.1%", color = "black", size = 3)+
  annotate(geom = "text", x = -1192152.6,y = 809288.2, label = "6.7%", color = "white", size = 3)+
  ...
  annotate(geom = "text", x = 2413606.1, y = 431394.6,label = "0.6%",color ="black", size = 3)+
  annotate(geom = "text", x = 2695757.5, y = 152727.5,label = "22%", color = "black", size = 3)+
...
m2 <- pr_geographic2 %>%
  ...
  annotate(geom = "text",x = -115306.8,y = 644233.4, label = "1.0%", color = "white",size = 3)+
  annotate(geom = "text",x = 2163606.1, y = 0, label = "3.1%", color = "black", size = 3)+
  annotate(geom = "text",x=-1192152.6,y = 809288.2, label = "16%", color = "white",size = 3)+
  annotate(geom = "text",x = -1867594.7,y =912726.5, label = "5.2%", color = "white",size = 3)+
  annotate(geom = "text",x = -675361.6,y = 487741.4, label = "0.8%", color = "white",size = 3)+
  ...
  annotate(geom = "text",x = 2695757.5, y = 152727.5, label = "19%", color = "black", size = 3)+
...
m3 <- pr_geographic %>%
  ...
  geom_text(data =df.label, aes(x = new.long, y = new.lat, group = 1, label = Daily), 
            size = 4, color = "white")+ 
  annotate(geom = "text",x = 642412.6,y = 201110.2,label = "816", color = "black", size = 4)+
...
(p6+p5)/(m3+m4)/(m1+m2) + plot_layout(heights = unit(c(0.4, 0.5,0.5), c('null', 'null','null'))) + plot_annotation(tag_levels = 'A')
ggsave("Figure/Figure1.png", width = 16, , height = 20, dpi= 500)
